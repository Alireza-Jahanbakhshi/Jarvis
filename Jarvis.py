...
def news():
    main_url = (
        'http://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey="YOUR_API_HERE"'
    )
...
if __name__ == "__main__":  # main program
    ...
    while True:
        ...
        if "open notepad" in query:
            ...
            kit.sendwhatmsg(
                "+91_To_number_you_want_to_send", "this is testing protocol", 4, 13
            )
            time.sleep(120)
        ...
        elif "email to Parisa" in query:
            try:
                speak("what should i say?")
                content = takecommand().lower()
                to = "EMAIL OF THE OTHER PERSON"
                sendEmail(to, content)
                speak("Email has been sent to Parisa")
        ...
        ###########################################################################################################################################
            ...
            if "send a file" in query:
                ...
                send_to_email = (
                    "To_person@gmail.com"  # Whom you are sending the message to
                )
